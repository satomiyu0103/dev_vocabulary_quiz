...
| ドキュメント | 内容 |
|---|---|
| [要件定義書.md](要件定義書.md) | **利用者要望ベース**の目的・機能／非機能・コンテンツ品質・受け入れ基準（実装前の合意正本） |
...
- **利用者要望・UX・コンテンツ品質**の変更は [要件定義書.md](要件定義書.md) を先に更新する
- **データフロー・アーキテクチャ・フェーズ**の変更は [企画書.md](企画書.md) を更新する
- 実装着手前に要件定義書 → 企画書 → DESIGN.md の整合を取る
